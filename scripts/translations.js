...
const translations = {
    ...
    categoryInUseMessage: "Táto kategória sa používa v {count} produktoch. Naozaj chcete vymazať kategóriu? Produkty zostanú bez kategórie.",
        ...
        inventoryReport: "Inventúra produktov",
        ...
        // Inventory
        startInventory: "Spustiť inventúru",
        exportInventory: "Exportovať inventúru",
        exportToExcel: "Exportovať do Excel",
        exportToPDF: "Exportovať do PDF",
        finishInventory: "Dokončiť inventúru",
        savedInventories: "Uložené inventúry",
        inventoryStarted: "Inventúra spustená",
        inventoryExported: "Inventúra exportovaná",
        inventoryExportedPDF: "Inventúra exportovaná do PDF",
        inventoryFinished: "Inventúra dokončená",
        noInventoryData: "Žiadne dáta inventúry",
        noDataToExport: "Žiadne dáta na export",
        noSavedInventories: "Žiadne uložené inventúry",
        totalProductsInventory: "Celkovo produktov",
        matches: "Zhodné",
        differences: "Rozdiely",
        pending: "Nezapočítané",
        systemQuantity: "Systém",
        actualQuantity: "Skutočné",
        inventoryCorrection: "Korekcia inventúry",
        confirmFinishInventory: "Naozaj chcete dokončiť inventúru? {count} produktov má rozdiely v množstve.",
        confirmDeleteInventory: "Naozaj chcete vymazať túto inventúru?",
        confirmClearInventories: "Naozaj chcete vymazať všetky uložené inventúry?",
        inventoryDeleted: "Inventúra vymazaná",
        allInventoriesDeleted: "Všetky inventúry vymazané",
        inventoryLoaded: "Inventúra načítaná",
        inventoryNotFound: "Inventúra nenájdená",
    ...
    categoryInUseMessage: "This category is used in {count} products. Do you really want to delete the category? Products will remain without category.",
        ...
        inventoryReport: "Product Inventory",
        ...
        finishInventory: "Finish Inventory",
        savedInventories: "Saved Inventories",
        inventoryStarted: "Inventory started",
        inventoryExported: "Inventory exported",
        inventoryExportedPDF: "Inventory exported to PDF",
        inventoryFinished: "Inventory finished",
        noInventoryData: "No inventory data",
        noDataToExport: "No data to export",
        noSavedInventories: "No saved inventories",
        totalProductsInventory: "Total Products",
        matches: "Matches",
        ...
        confirmFinishInventory: "Do you really want to finish the inventory? {count} products have quantity differences.",
        confirmDeleteInventory: "Do you really want to delete this inventory?",
        confirmClearInventories: "Do you really want to delete all saved inventories?",
        inventoryDeleted: "Inventory deleted",
        allInventoriesDeleted: "All inventories deleted",
